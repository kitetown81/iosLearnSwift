...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        // If using a storyboard, the `window` property will automatically be initialized and attached to the scene.II
...
//        //item.image = UIImage(named: "桌面")
//        item.title = "home"
//        
//        let item2 = tabBar.items![1]
//        //item.image = UIImage(named: "锁屏")
//        item2.title = "setting"
//        item2.badgeValue = "9"
//        UITabBar.appearance().backgroundColor = UIColor(white: 1, alpha: 1)
